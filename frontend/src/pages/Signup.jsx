...
const Signup = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-blue-900 px-4">
    {/* Top-left QSIM Logo */}
    <Link
      to="/"
      className="absolute top-6 left-6 text-2xl sm:text-3xl font-bold text-cyan-400"
    >
      QSIM
    </Link>
